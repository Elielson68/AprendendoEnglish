...
| Números de 20 a 100: | por Extenso:                                                                                                                                                              |
| :------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| English:        | Pronúncia | Portuguese (Translate) |
| :-------------- | :-------- | :--------------------- |
...
| **PRIMITIVO:**               | nomeia nomes únicos, mas pode originar diferentes termos                                                                                                                                                                                     | livro, noite, água, pedra                                                                                                          |
...
Além dos tempos verbais (**VERB TENSES**), o tempo é também indicado pelo uso de certos advérbios de tempo.

| ADVÉRBIOS DE TEMPO | Conceitos                                                                                                                                                                                                          |
| :----------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Definição:         | **São palavras em inglês usadas para falar sobre:**<br> ➥ Quando ocorreu uma ação,<br> ➥ Com que frequência uma ação acontece, <br> ➥ Quanto tempo essa ação dura <br> ➥ E também para descrever cadeias de ações. |

**Podemos classificar os ADVÉRBIOS DE TEMPO em seis(6) tipos:** 
- **Precisos / Definidos**
- **Imprecisos / Indefinidos**
- **Cadeia de Acontecimentos**
- **Duração**
- **Frequência**
- **Passado Recente**

# ADVÉRBIOS DE TEMPO <Br>(Precisos / Definidos)

| ADVÉRBIOS DE TEMPO<br> (Precisos / Definidos) | Translate                                 | Concepts                                                 | Examples                                                                             |
| :-------------------------------------------- | :---------------------------------------- | :------------------------------------------------------- | :----------------------------------------------------------------------------------- |
| **Today/Yesterday/Tomorrow**                  | **(Hoje, Ontem e Amanhã)**                | ● Indicam uma **DATA ou TEMPO ESPECÍFICO para uma ação** | ➥ **Tomorrow** i will go to the beach                                                |
| **Now/Tonight**                               | **(Agora, essa noite)**                   | ● Indicam uma **DATA ou TEMPO ESPECÍFICO para uma ação** | ➥ I need eat **right now**<br> ➥ I want this **now**                                 |
| **Last week/month**                           | **(Semana/mês passado)**                  | ● Indicam uma **DATA ou TEMPO ESPECÍFICO para uma ação** | ➥ **Last week** i traveled to Brazil                                                 |
| **Next weekend/friday**                       | **(Próximo final de semana/sexta feira)** | ● Indicam uma **DATA ou TEMPO ESPECÍFICO para uma ação** | ➥ **Last week** they went to the beach <br> ➥ **Next year** they are moving to Japan |
| **Two hours/years ago**                       | **(2 horas/anos atrás)**                  | ● Indicam uma **DATA ou TEMPO ESPECÍFICO para uma ação** | ➥ Our friend called you **two hours ago**<br> ➥ I was in Dubai **two years ago**     |
| **Early/Late**                                | **(Cedo/Tarde)**                          | ● Indicam uma **DATA ou TEMPO ESPECÍFICO para uma ação** | ➥ I woke up **early** <br> ➥ She is ten minutes **late** to the meeting              |
- - -
# ADVÉRBIOS DE TEMPO <br>(Imprecisos / Indefinidos)

| ADVÉRBIOS DE TEMPO <BR> (Imprecisos / Indefinidos) | Translate                            | Concepts                                                                                   | Examples                                                                                                                                                  |
| :------------------------------------------------- | :----------------------------------- | :----------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Someday**                                        | **(Algum dia)**                      | ● Indicam: **SITUAÇÕES INDEFINIDAS**, em que não é necessário indicar um tempo específico. | ➥ We could grab a coffee **someday**                                                                                                                      |
| **Long ago / Long time ago / Long time**           | **(Muito tempo atrás)**              | ● Indicam: **SITUAÇÕES INDEFINIDAS**, em que não é necessário indicar um tempo específico. | ➥ She was his friend **long ago** <br> ➥ **Long time ago** they were friends <br> ➥ It has been a **long time** since we met                              |
| **In the past / present / Future**                 | **(No passado, presente ou futuro)** | ● Indicam: **SITUAÇÕES INDEFINIDAS**, em que não é necessário indicar um tempo específico. | ➥ **In the past**, I used to dance<br> ➥ **In the present**, I am investing in a new business <Br> ➥ **In the future**, I intend to buy a house           |
| **Nowadays / Currently / Lately**                  | **(Atualmente ou Ultimamente)**      | ● Indicam: **SITUAÇÕES INDEFINIDAS**, em que não é necessário indicar um tempo específico. | ➥ It has been raining a lot **Lately** <Br> ➥ **Nowadays** people use their phones to post on instagram <br> ➥ He is **Currently** working in an industry |
| **Recently**                                       | **(Recentemente)**                   | ● Indicam: **SITUAÇÕES INDEFINIDAS**, em que não é necessário indicar um tempo específico. | ➥ **We have met recently**                                                                                                                                |

- - - 

# ADVÉRBIOS DE TEMPO <br>(Sequência de Acontecimentos)

| ADVÉRBIOS DE TEMPO <BR> (Cadeia de acontecimentos)                           | Translate                            | Concepts                                                                                                                         | Examples                                                                                                                     |
| :--------------------------------------------------------------------------- | :----------------------------------- | :------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------- |
...
**Em resumo:** <br>
>**SIMPLE**<Br> **➥** PRESENT, PAST and FUTURE <BR><BR>**CONTINUOUS**<Br>**➥** PRESENT, PAST and FUTURE<br><br> **PERFECT**<Br> **➥** PRESENT, PAST and FUTURE<br><br> **PERFECT CONTINUOUS**<Br>**➥** PRESENT, PAST and FUTURE
- - -

# VERBO TO BE (Conceitos e Conjugações)

| VERBO TO BE <br> (Ser ou Estar) | Conceitos:                                                                                                                                                                                                                                                                       |
| :------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Definição:**                  | É um dos verbos mais utilizados da lingua inglesa e pode ser traduzido como: **SER** ou **ESTAR**, não existe uma regra para saber quando ele significa **SER** ou **ESTAR**, é necessário compreender o contexto da mensagem, para então entender o sentido do verbo na frase.. |
| **Classificação:**              | É classificado como **VERBO IRREGULAR**, isso porque não segue as regras de formação do passado simples e do particípio passado.<br>                                                                                                                                             |
| **Utilização:**                 | Pode ser usado como **VERBO PRINCIPAL** e como **VERBO AUXILIAR** de alguns tempos verbais.                                                                                                                                                                                      |

<br>

| VERBO TO BE <br> (Ser ou Estar) | Simple Present<br>(am / is / are) | Affirmative                                          | Negative                                                   | Interrogative              |
| :------------------------------ | :-------------------------------- | :--------------------------------------------------- | :--------------------------------------------------------- | :------------------------- |
|                                 | <Br>                              | ➥ I **am**<Br> ➥ **I'm**                             | ➥ I **am not**<br> ➥ I **'m not**                          | ➥ **Am I...?**             |
|                                 | <br>                              | ➥ You **are**<Br> ➥ **You're**                       | ➥ You **are not** <br> ➥ You **aren't**                    | ➥ **Are you...?**          |
|                                 |                                   | ➥ He / She / It **is**<Br> ➥ He's / She's / **It's** | ➥  He / She / It **is not** <br> ➥ He / She / It **isn't** | ➥ **Is He / She / It...?** |
|                                 |                                   | ➥ We **are**<Br> ➥ **We're**                         | ➥ We **are not** <br> ➥ We **aren't**                      | ➥ **Are we...?**           |
|                                 |                                   | ➥ You **are**<Br> ➥ **You're**                       | ➥ You **are not** <br> ➥ You **aren't**                    | ➥ **Are you...?**          |
|                                 |                                   | ➥ They **are**<Br> ➥ **They're**                     | ➥ They **are not** <br> ➥ They **aren't**                  | ➥ **Are they...?**         |

**Observações:**
> - As formas negativas dos verbos em inglês sempre terão a presença da palavra “not”.
> <br> 
> - **IT / IT's** é utilizado para objetos e animais (SEMPRE NO SINGULAR.)
> <br>
> - Com o verbo to be, **is** e **are** podem se contrair com o not (isn’t, aren’t). Cuidado que o am não entra nesse caso!
> <Br>
> - Interrogativas, em inglês, têm a característica de apresentarem o verbo na frente do sujeito. Com o verbo to be não é diferente.
> <br>
> - Repare que o pronome You é igual no singular e no plural? Isso faz com que o verbo também fique igual (“are”) e facilita bastante na hora de gravar. No entanto, preste bastante atenção porque a identificação da classificação por número (ou seja, singular ou plural) dentro do texto vai ser feita através do contexto em que o pronome foi inserido. Por isso, é sempre bom ler a frase toda quando estiver na dúvida, beleza?


- - -
| VERBO TO BE <br> (Ser ou Estar) | Simple Past<br>(was / were) | Affirmative                                           | Negative                                                    | Interrogative                          |
| :------------------------------ | :-------------------------- | :---------------------------------------------------- | :---------------------------------------------------------- | :------------------------------------- |
|                                 |                             | ➥ I **was**                                           | ➥ I **was not**<br> ➥ I **wasn't**                          | **Was I...?**                          |
|                                 |                             | ➥ You **were**<br> ➥ **You're**                       | ➥ You **were not** <br> ➥ You **weren't**                   | **Were you...?**                       |
|                                 |                             | ➥ He / She / It **was**<br> ➥ **He's / She's / It's** | ➥ He / She / It **was not** <br> ➥ He / She / It **wasn't** | **Was he / she / it...?**              |
|                                 |                             | ➥ We **were** <br> ➥ **We're**                        |                                                             | ➥ We **were not**<br> ➥ We **weren't** | **Were we...?** |
|                                 |                             | ➥ You **were** <br> ➥ **You're**                      | ➥ You **were not** <br> ➥ You **weren't**                   | **Were you...?**                       |
...
Você tem, abaixo, os principais valores de algumas preposições:
...
= ■■ Podem ser totalmente diferentes, exemplo:
 ________________________________________________________________________________________________________________________
|Infinitivo        |Passado Simples          |Passado Participio       |Tradução                                         |
|"Infinitive"      |"Simple Past"            |"Past Participle"        |"Translation"                                    | 
|__________________|_________________________|_________________________|_________________________________________________|
|■ Arise           | Arose                   |Arisen                   | surgir;formar(-se)                              |
|■ Awake           | Awoke                   |Awoken                   | acordar, estar acordado                         |
|■ Babysit         | Babysat                 |Babysat                  | cuidar de uma criança para alguém (como babá)   |
|■ Be (am/is/are)  | Was/Were                |Been                     | ser, estar                                      |
|■ Bear            | Bore                    |Borne (Br)/Born (Am)     | suportar, sustentar                             |
|■ Beat            | Beat                    |Beaten                   | vencer, derrotar                                |           
|■ Become          | Became                  |Become                   | tornar(-se), passar a ser                       |
|■ Begin           | Began                   |Begun                    | começar, iniciar                                |           
|■ Bet             | Bet                     |Bet                      | apostar                                         |            
|■ Bind            | Bound                   |Bound                    | ligar; encardenar; contratar                    |    
|■ Blow            | Blew                    |Blown                    | soprar; tocar (instrumento de sopro)            |
|■ Break           | Broke                   |Broken                   | quebrar, partir                                 |
|■ Bring           | Brought                 |Brought                  | trazer; causar                                  |
|■ Build           | Built                   |Built                    | construir; formar                               | 
|■ Burn            | Burnt/Burned            |Burnt (Br)/Burned (Am)   | queimar; arder                                  |
|■ Buy             | Bought                  |Bought                   | comprar                                         |
|■ Catch           | Caught                  |Caught                   | pegar, apanhar, agarrar                         |
|■ Choose          | Chose                   |Chosen                   | escolher, selecionar                            |
|■ Come            | Came                    |Come                     | vir                                             |
|■ Cost            | Cost                    |Cost                     | custar                                          |
|■ Cut             | Cut                     |Cut                      | cortar, partir                                  |
|■ Deal            | Dealt                   |Dealt                    | tratar, lidar com                               |
|■ Do (do/does)    | Did                     |Done                     | fazer                                           |
|■ Draw            | Drew                    |Drawn                    | desenhar, planejar                              |
|■ Dream           | Dreamt/Dreamed          |Dreamt (Br)/Dreamed (Am) | sonhar; desejar; planejar                       |
|■ Drink           | Drank                   |Drunk                    | beber                                           |
|■ Drive           | Drove                   |Driven                   | dirigir, guiar; conduzir                        |
|■ Eat             | Ate                     |Eaten                    | comer                                           |
|■ Fall            | Fell                    |Fallen                   | cair; baixar                                    |
|■ Feed            | Fed                     |Fed                      | alimentar(-se); suprir                          |
|■ Feel            | Felt                    |Felt                     | sentir(-se)                                     |
|■ Fight           | Fought                  |Fought                   | brigar; lutar                                   |
|■ Find            | Found                   |Found                    | achar, econtrar                                 |
|■ Fly             | Flew                    |Flown                    | voar; pilotar                                   |
|■ Forget          | Forgot                  |Forgotten                | esquecer                                        |
|■ Forgive         | Forgave                 |Forgiven                 | perdoar, desculpar                              |
|■ Get             | Got                     |Got (Br)/Gotten (Am)     | receber, obter, conseguir                       |
|■ Give            | Gave                    |Given                    | dar                                             |
|■ Go              | Went                    |Gone                     | ir                                              |          
|■ Grow            | Grew                    |Grown                    | crescer, cultivar                               |
|■ Have (have/has) | Had                     |Had                      | ter, possuir                                    |
|■ Hear            | Heard                   |Heard                    | ouvir, escutar                                  |
|■ Hide            | Hid                     |Hidden                   | esconder(-se), ocultar(-se)                     |
|■ Hit             | Hit                     |Hit                      | bater                                           |
|■ Hold            | Held                    |Held                     | prender, segurar, agarrar-se a; aguentar; sediar|
|■ Hurt            | Hurt                    |Hurt                     | ferir, machucar(-se)                            | 
|■ Keep            | Kept                    |Kept                     | guardar; manter; permanecer; ficar; continuar   |
|■ Know            | Knew                    |Known                    | saber; conhecer                                 |       
|■ Lead            | Led                     |Led                      | levar, conduzir                                 |            
|■ Learn           | Leaned (Am)/Learnt (Br) |Learned (Br)/learnt (Br) | aprender                                        |
|■ Leave           | Left                    |Left                     | sair, deixar, partir, ir embora; abandonar      |
|■ Lend            | Lent                    |Lent                     | emprestar                                       |
|■ Let             | Let                     |Let                      | deixar, permitir                                |
|■ Lie             | Lied                    |Lied                     | mentir                                          |
|■ Lie             | Lay                     |Lain                     | encontrar(-se)                                  |
|■ Lose            | Lost                    |Lost                     | perder                                          |
|■ Make            | Made                    |Made                     | fazer, criar, produzir                          |  
|■ Mean            | Meant                   |Meant                    | significar, querer dizer                        |
|■ Meet            | Met                     |Met                      | encontrar(-se)                                  |
|■ Overcome        | Overcame                |Overcome                 | superar                                         |
|■ Oversee         | Oversaw                 |Overseen                 | fiscalizar; conferir                            | 
|■ Put             | Put                     |Put                      | pôr, colocar                                    |
|■ Read            | Read                    |Read                     | ler                                             |
|■ Rethink         | Rethought               |Rethought                | repensar, rever uma ideia                       |
|■ Rewrite         | Rewrote                 |Rewritten                | reescrever                                      |
|■ Rid             | Rid                     |Rid                      | livrar(-se)                                     |
|■ Ride            | Rode                    |Ridden                   | montar, cavalgar, andar de                      |
|■ Ring            | Rang                    |Rung                     | soar, tocar                                     |
|■ Rise            | Rose                    |Risen                    | surgir, subir, erguer; levantar(-se)            |
|■ Run             | Ran                     |Run                      | correr; conduzir, dirigir (negócio); funcionar  |
|■ Say             | Said                    |Said                     | dizer, falar                                    |
|■ See             | Saw                     |Seen                     | ver, enxergar                                   |
|■ Seek            | Sought                  |Sought                   | procurar, buscar v                              |
|■ Sell            | Sold                    |Sold                     | vender                                          |
|■ Send            | Sent                    |Sent                     | enviar, remeter                                 |
|■ Set             | Set                     |Set                      | pôr; fixar; arrumar                             |
|■ Shed            | Shed                    |Shed                     | derramar; deixar cair; largar                   |
|■ Shine           | Shone                   |Shone                    | brilhar; iluminar; irradiar                     |  
|■ Shoot           | Shot                    |Shot                     | fotografar; disparar                            |
|■ Show            | Showed                  |Showed/Shown             | mostrar                                         |
|■ Sing            | Sang                    |Sung                     | cantar                                          |        
|■ Sit             | Sat                     |Sat                      | sentar(-se), estar sentado                      |
|■ Sleep           | Slept                   |Slept                    | dormir                                          |   
|■ Speak           | Spoke                   |Spoken                   | falar, dizer                                    |
|■ Spend           | Spent                   |Spent                    | passar (tempo); gastar; consumir                |
|■ Split off       | Split off               |Split off                | separar(-se)                                    |
|■ Spread          | Spread                  |Spread                   | espalhar, estender                              |
|■ Stand           | Stood                   |Stood                    | estar de pé, ficar de pé                        |
|■ Steal           | Stole                   |Stolen                   | roubar, furtar                                  |
|■ Stick           | Stuck                   |Stuck                    | fincar; aderir; fixar; grudar                   |
|■ Strike out      | Struck out              |Struck out               | golpear, atacar; acertar, atingir               |
|■ Sweep           | Swept                   |Swept                    | varrer; arrastar                                |
|■ Swim            | Swam                    |Swum                     | nadar                                           |
|■ Take            | Took                    |Taken                    | pegar, tomar                                    |
|■ Teach           | Taught                  |Taught                   | ensinar, lecionar                               |
|■ Tear            | Tore                    |Torn                     | rasgar, separar; arrancar                       |
|■ Tell            | Told                    |Told                     | dizer, contar                                   |
|■ Think           | Thought                 |Thought                  | pensar                                          |
|■ Throw           | Threw                   |Thrown                   | lançar; atirar (algo); jogar                    |
|■ Undergo         | Underwent               |Undergone                | fazer, cumprir, realizar                        |
|■ Understand      | Understood              |Understood               | entender, compreender                           |
|■ Unwind          | Unwound                 |Unwound                  | relaxar, descansar                              |
|■ Wake            | Woke                    |Woken                    | acordar, despertar                              |
|■ Wear            | Wore                    |Worn                     | usar, vestir; gastar                            |
|■ Win             | Won                     |Won                      | ganhar, vencer, obter, conquistar               |
|■ Wind            | Wound                   |Wound                    | dar corda; torcer                               |      
|■ Withdraw        | Withdrew                |Withdrawn                | extrair, retirar, sacar, retratar(-se)          |
...
●●●● Exemplos ●●●●
●●●●●●●●●●●●●●●●●●
-> ■■ You want to build a sand castle like the one we built last month.
      ➥ Verbo Irregular "Build" (construir)
      ➥ Passado simples e particípio é "built" (construiu/construído)

-> ■■ He bet me that I couldn't run six miles without stopping. I proved him wrong;
      ➥ Verbo Irregular "Bet" (apostou) passado simples.
         As três formas (infinitivo, passado simples e particípio são exatamente iguais.) 

-> ■■ I ran nine miles before I had to catch my breath
      ➥ Verbo Irregular "Run" ("Correr")
         Ex: "Ran" (correu) é o passado simples e "run" (corrido) também é o passado particípio.

-> ■■ I awoke to find that a spider had bitten me.
      ➥ Verbo Irregular "Awoke" (despertou) 
         Ex: "Awoke" (despertou) é o passado simples de "awake"
      ➥ Verbo Irregular "Bitten" (mordida) é o particípio de "bite" (morder)

-> ■■ Although the wound didn't bleed, it itched terribly
      ➥ Verbo Irregular "Bleed" (sangrar) está na sua forma infinitiva.

-> ■■ Let's drink some of this lemonade. 
      ➥ Verbo irregular "drink" (beber) está no infinitivo. "Drank" é o passado simples (bebeu)

-> ■■ I drank some yersterday and found it delicious.    
      ➥ "Found" (achei/achou) é o passado simples de "Find" (achar/encontrar)
...
-> ■■ Geral
      ●● Verbo: 
         = Na terceira pessoa do Singular = He / She / IT - RUNS
           ➥ Acrescentar "S" - Final de Todos os Verbos 
        
         = Todos os demais Sem o "To"
           ➥ Forma Infinitiva = I / You / We / You / They - Run
      ...
      ●● Verbo na 3° Pessoa do Singular
         = Terminado
           ...
           em "in, s, z, sh, tch, ch"
            ...
            em "Have"
                ➥ He / She / It - HAS
                   Ex: He has a nice car.


-> ■■ Utilização do Past Simple

●● Opnião ●●
   ➥ I love ice cream. I dont't like cold food. 

●● Rotinas ●●
   ➥ The restaurant opens at eight. It doesn't open at 7.

●● Dia a dia ●● 
   ➥ Vitor eats a brea for brekfast every day. He doesn't eat cheese.
 
●● Fatos ●● 
   ➥ The moon circles the earth. The sun doesn't circle the moon


●● Exemplos:

-> ■ She drives to work every night
-> ■ He says he plays soccer on the weekends
-> ■ I have one sister and three brothers. But she has one brother and two sisters
-> ■ Do you like the table?
-> ■ Does she go to work?
-> ■ I don't speak Italiano
-> ■ My sister meets his boyfriend everyday
-> ■ John is a bus driver. He drives a bus. But on Sundays he doesn't drive his bus. He stays at home.
...
●● Present Continuous
   ➥ Expressar
   ➥ O verbo "to be " (no presente simples) + o verbo utilizado + ing
   ➥ Utilização
   ➥ Regras
...
-> ■■ Utilização ■■
      ●● Ações que estão acontecendo
         ➥ 1) Where is Bruna? He is having a bath. (... ela está tomando banho (de banheira)
       
         ➥ 2) What are you doing the moment in front of your screen? Don't you know? Well ... you are reading this lesson. You are learning English. (O que você está fazendo..? você está lendo esta lição. Você está aprendendo inglês) 
 
         ➥ 3) I am reading a book; It's a nice book. (Eu estou lendo um livro..)
     
      ●● Exceções
         ➥ Verbos em que Não se usa o Present Continuous:
            = "be, believe, belong, hate, hear, like, love, mean, prefer, remain, realize, see, seem, smell, thinl, understand, want, wish"
               Ex: She is wanting to buy a new computer.   (Ela está querendo... - Incorreto)
               Ex: She wants to buy a new computer.        (Ela quer comprar.. - Correto)

   
-> ■■ Regras ■■
      ●● UMA sílaba terminada em UMA vogal e UMA consoante
         ➥ Dobrar a última vogal
           Ex: Get -> getting
           Ex: Sit -> sitting
           Ex: Skip -> skipping
           Ex: Swim -> swimming
     ____________________________
     ●● Lie (mentir) e Die(morrer)
        Ex: Lying(mentindo) e Dying(morrendo)
     ____________________________
     ●● Travel (viajar) e Regret (arrepender)
        Ex: travelling (viajando) e regretting (arrependendo) - Últimas letras dobradas
     ____________________________
     ●● Demais palavras com duas ou mais sílabas
        Ex: Não tem sua última letra dobrada
     ____________________________
...
●●●●●●●●●●●
   -> ■■ Afirmativo ■■
         ➥ I, he, she, it -> was
         ➥ You, we, they  -> were
             Ex: I was in Florianópolis in 2010
             Ex: Neymar was in Barcelona in 2010
             Ex: We were not together
             Ex: He was my boyfriend

   -> ■■ Interrogativo ■■
         ➥ Was  -> I, he, she, it?
         ➥ Were -> You, we they?
            Ex: Were you in London last year?
            Ex: Was Bruna with you?
            Ex: Were you together?

   -> ■■ Negativo ■■
         ➥ I, you, he, she -> was not / wasn't
         ➥ You, we, they -> were not / weren't
            Ex: I wasn't in Florianópolis in 2010
            Ex: Neymar wasn't in Barcelona in 2010
            Ex: We weren't in Paris 

●●●●●●●●●●●●●●●●●●●●
●● Demais Verbos: ●●
●●●●●●●●●●●●●●●●●●●●
   -> ■■ Verbos Regulares
         ➥ was, lived, started, wrote, died (seguir as regras dos verbos regulares)
   
   -> ■■ Verbos Irregulares
         ➥ Wrote, cut, got, let (seguir as regras dos verbos irregulares)
...
●●●●●●●●●●●●●●●●  
   -> ■■ Afirmativo
         ➥ I, you, he, she, it, we, they -> Played/Wrote/Did. 
            Ex: I played soccer with my cousins yersterday
            Ex: I finished dinner and I did my homework.

   -> ■■ Interrogativo
         ➥ Did -> I, you, he, she, it, we, they Play / write / do?
            Ex: Did you play soccer yersterday?
            Ex: Did you watch television this morning?
            Ex: Did you do the homework?

   -> ■■ Negativo
         ➥ I, you, he, she it, we, they, -> did not / didn't play / write / do.
            Ex: I didn't like the food in the wedding last saturday.
            Ex: I didn't eat it

●●●●●●●●●●●●●●●●
●● Situações: ●●
●●●●●●●●●●●●●●●●
-> ■■ Evento que se encerrou no passado:
      Ex: William Shakespeare wrote Hamlet
      Ex: Chritoph Colombus discovered America in 1492
      Ex: He kissed her and left

-> ■■ Ações que eram hábitos no passado:
      Ex: I visited them every day for two months.
      Ex: I drove to work every day when I worked with that company.

-> ■■ Ações que eram verdade no passado:
      Ex: He lived in London for 20 years
      Ex: They talked on the phone for 30 minutes.
...
■■ Past Continuous ■■
●● Past Progressive = Ação Contínua = No passado
●● Estrutura
   ➥ Verbo "To Be" no passado simples + o verbo principal + ing
   ➥ Utilização 
_________________________________________________
■■■■■■■■■■■■■■■■■■■■■
■■ Past Continuous ■■
...
➥➥ Verbo "To Be" no passado simples + o verbo principal + ing
     -> ■ Afirmativo  ( I, he, she, it >> was  >> Playing. )
                      ( You, we, they  >> were >> Playing. ) 
                      Ex: Yesterday morning I was watching a film, when someone knocked on the window.
                      Ex: This morning I was revising my lessons when your mother came in.
                      Ex: Luana and Carol were playing tennis yesterday at 09:00
     
     -> ■ Negativo ( I, he, she, it >> was not / wasn’t >> playing. )
                   ( you, we, they  >> were not / weren’t >> playing. )
                    Ex: I wasn’t reading a book yesterday morning; I was watching TV
                    Ex: My father wasn’t preparing dinner; he was playing on the computer
                    Ex: We weren’t playing soccer.

     -> ■ Interrogativo ( Was >> I, he, she, it >> playing? )
                        ( Were >> you, we, they >> playing? )
                         Ex: What were you doing yesterday morning?
                         Ex: And what was your father doing?
                         Ex: Where were you going, this afternoon at 4pm? 
                         Ex: What were John and Carlos doing?
   

➥➥ Utilização
     -> ■ Expressar que "alguém" estava no meio de alguma tarefa em um momento específico no passado
          Ex: "This time yersterday, I was preparing my dinner."

     -> ■ Expressar que alguma coisa aconteceu no meio de algum outro acontecimento
          Ex: "Doug burnt his thumb when he was cooking dinner yersterday"
          Ex: "While I was working in the gardem, I hurt my hand."
...
●● Utilizações
   ...
   ➥ Previsão de situação futura
   ➥ Combinado
   ➥ Condicionais do tipo um (First conditional)
...
●●●●●●●●●●●●●●●●●●●●●●
   -> ■■ Afirmativo
         ...
         Ex: I think I will buy a new car = I think I’ll buy a new car
         Ex: I will open the window = I’ll open the window

   -> ■■ Interrogativo
         ➥ (I, you, he, she, it, we, they + will not/won't + verb)
            Ex: Will you buy a car?
            Ex: Will you go to the restaurant?

   -> ■■ Negativo
         ➥ (I, you, he, she, it, we, they + will not / won’t + verb)
            Ex: I will not stay at home if I finish the housework.
            Ex: I won't visit Big Ben if I go to London.

●●●●●●●●●●●●●●●●●●
●● Utilizações: ●●
●●●●●●●●●●●●●●●●●●
   -> ■■ Decisões Instantâneas
         Ex: I’ve left the window open, I’ll close it.
   
   -> ■■ Previsão de situação futura
         Ex: He‘ll pass the exam. He’s hardworking.
   
   -> ■■ Combinado
         Ex: “I (don’t) think…”, “I expect…”, “I’m sure…”, “I wonder…”, “probably”.
         Ex: It will probably rain tonight, I wonder what will happen?

   
   -> ■■ Condicionais do tipo um (First conditional)
         Ex: If I have enough time, I’ll watch the film.


●●●●●●●●●●●●●●●●●●
●● Observações: ●●
●●●●●●●●●●●●●●●●●●    
   -> ■■ Não se usa o Simple Future para falar o que alguém já decidiu ou planejou fazer no futuro.
   -> ■■ Ao invés do Simple Future, se usa o "Present Continuous" ou o "Going to + verbo"
         Ex: Ann is traveling to New York next week.
             ➥(NÃO, “Ann will travel “)
     
         Ex: Are you going to watch television? 
             ➥(NÃO “will you watch“).
   
   -> ■■ É possivel usar o "shall" ao invés de "will" para I e WE 
         Ex: I shall play soccer. (Or, I will play …) 
         Ex: We shall play soccer. (Or, we will play …)

   -> ■■ 'll' é a forma contraída de will. Você pode usar das duas maneiras:
          Ex: I will go, or
          Ex: I'll go.

   -> ■■ Won't é a forma reduzida de will not
         Ex: I will not go, or
         Ex: I won't go
...
■■■ Future Continuous/Progressive ■■■
●● Eventos Futuros:
   ➥ Ocorrendo em um tempo específico também no futuro = Fazer contraste
   -> ■ Formas: 
        - Afirmativa
        - Negativa
        - Interrogativa
   ...
   -> ■ Comumente usado: 
        - While, when, this time tomorrow, this time next week, in the afternoon, next month, next week, next year, etc..
...
● Formas: ●
●●●●●●●●●●●
  -> ■■ Afirmativa (Subject + will + be + ing form of the verb)
        Ex: I will be driving. (I’ll be… - contração) - Eu vou estar (estarei) dirigindo
        Ex: He will be playing. (He’ll be… - contração) - Ele vai estar (estará) jogando.

  -> ■■ Negativa(Subject + will + not + be + ing form of the verb)
        Ex: I will not be driving. (I won’t be…) Eu não vou estar (não estarei)...
        Ex: He will not be playing. (He won’t be…) Ele não vai estar (não estará)...

  -> ■■ Interrogativa(Will + subject + be + ing form of the verb)
        Ex: Will she be driving? - Ela vai estar (estará) dirigindo?.
        Ex: Will they be leaving? - Eles vão estar (estarão) dirigindo?

  -> ■■ Comumente usado: 
        ➥ While, when, this time tomorrow, this time next week, in the afternoon, next month, next week, next year, etc..
          Ex: This time next week I will be lying on the beach. 
              (Neste mesmo momento na próxima semana, eu vou estar deitando (deitado) na praia)

          Ex: This time next week we will be celebrating your birthday. 
              (Neste mesmo momento na próxima semana, eu vou estar celebrando(comemorando) seu aniversário.

        ➥ Previsões sobre o presente
          Ex: Father will be cooking lunch now. 
              (Aqui se está falando sobre algo que pode estar acontecendo neste momento, apesar da estrutura usada ser o Futuro Continuous 
               o Pai vai estar (estará) cozinhando o almoço agora.
       
          Ex: He will be getting ready for school. 
              (Ele vai estar (estará) se aprontando para a escola).
        
          Ex: Don’t call her now. She will be having lunch.
              (Não a chame agora. Ela vai estar (estará) almoçando.


        ➥ Outros eventos futuros
           Ex: This time tomorrow I will be taking my exam. 
               (Neste mesmo momento amanhã eu estarei fazendo minha prova).
      
           Ex: This time next week I will be waiting at the doctor’s office. 
               (Neste mesmo momento na semana que vem eu vou estar esperando no consultório).
      
           Ex: He will be giving a presentation at 2 o’clock in the afternoon. 
               (He vai estar apresentando às 2 horas da tarde).      
